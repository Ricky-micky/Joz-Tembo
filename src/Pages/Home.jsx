...
export default function Home() {
  ...
  return (
    <>
      {/* ===== SEO Meta Tags ===== */}
      <Helmet>
        <title>Joz Tembo Tours – Safari Adventures in Kenya</title>
        <meta
          name="description"
          content="Explore Kenya's national parks with Joz Tembo Tours. Book unforgettable safari experiences, luxury lodges, and guided wildlife tours. Discover Maasai Mara, Amboseli, Tsavo & more."
        />
        <link rel="canonical" href="https://www.joztembotours.com/" />

        {/* Open Graph for social sharing */}
        <meta
          property="og:title"
          content="Joz Tembo Tours – Safari Adventures in Kenya"
        />
        <meta
          property="og:description"
          content="Explore Kenya's national parks with Joz Tembo Tours. Book unforgettable safari experiences, luxury lodges, and guided wildlife tours."
        />
        <meta
          property="og:image"
          content="https://www.joztembotours.com/og-image.jpg"
        />
        <meta property="og:url" content="https://www.joztembotours.com/" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Joz Tembo Tours" />
        ...
        <meta
          ...
          content="Explore Kenya's national parks with Joz Tembo Tours. Book unforgettable safari experiences."
        />
        <meta
          name="twitter:image"
          content="https://www.joztembotours.com/og-image.jpg"
          ...
          {`
            {
              ...
              "@type": "TravelAgency",
              "name": "Joz Tembo Tours",
              "url": "https://www.joztembotours.com",
              "logo": "https://www.joztembotours.com/logo.png",
              "description": "Safari tours and travel agency in Kenya offering wildlife safaris, lodge bookings, and adventure travel.",
              "address": {
                "@type": "PostalAddress",
              ...
              "contactPoint": {
                ...
                "email": "info@joztembotours.com"
              },
              "sameAs": [
                "https://www.facebook.com/joztembotours",
                "https://www.instagram.com/joztembotours"
              ]
            }
          `}
        </script>
            ...
            <div className="bg-white rounded-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="relative h-40 md:h-64">
                <img
                  ...
                  className="w-full h-full object-cover"
                  onError={(e) =>
                    handleImageError(e, selectedPark.fallbackImage)
                  }
                />
                <button
                  onClick={closeModal}
